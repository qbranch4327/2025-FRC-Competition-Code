...
public class TunerConstants {
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.11);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.45849609375);
    private static final boolean kFrontLeftSteerMotorInverted = true;
    private static final boolean kFrontLeftCANcoderInverted = false;

    private static final Distance kFrontLeftXPos = Inches.of(7.25);
    private static final Distance kFrontLeftYPos = Inches.of(7.25);

    // Front Right
    private static final int kFrontRightDriveMotorId = 3;
    private static final int kFrontRightSteerMotorId = 7;
    private static final int kFrontRightEncoderId = 1;
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.440673828125);
    private static final boolean kFrontRightSteerMotorInverted = true;
    private static final boolean kFrontRightCANcoderInverted = false;

    private static final Distance kFrontRightXPos = Inches.of(7.25);
    private static final Distance kFrontRightYPos = Inches.of(-7.25);
    ...
    private static final Distance kBackLeftXPos = Inches.of(-7.25);
    private static final Distance kBackLeftYPos = Inches.of(7.25);
    ...
    private static final Distance kBackRightXPos = Inches.of(-7.25);
    private static final Distance kBackRightYPos = Inches.of(-7.25);
    ...
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> FrontRight = ConstantCreator.createModuleConstants(
    ...
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> BackRight = ConstantCreator.createModuleConstants(
